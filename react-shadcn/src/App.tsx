  ...
  return (
    <div className="flex h-screen overflow-hidden bg-surface-lowest c-fg font-sans">
      <aside className="w-64 border-r border-border flex-shrink-0 flex flex-col p-6 bg-surface z-10">
        ...
        <Card className="bg-foreground c-surface mt-auto overflow-hidden relative border-none">
          ...
          <CardContent className="relative z-10 p-6">
            ...
            <Button variant="secondary" className="w-full border-ghost bg-surface-highest text-foreground">Download</Button>
          </CardContent>
        </Card>
      </aside>
      ...
      <main className="flex-1 flex flex-col h-screen overflow-y-auto">
        <header className="row-between px-10 py-6 border-b border-border glass sticky top-0 z-40 w-full">
          <div className="relative w-72">
            ...
            <Input className="pl-10 w-full" placeholder="Search tasks ⌘F" />
          </div>
          <div className="row gap-4">
            <Button variant="ghost" className="btn-icon radius-full"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg></Button>
            <Button variant="ghost" className="btn-icon radius-full"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg></Button>
        ...
        <div className="p-10 stack gap-8">
          <div className="row-between">
            ...
            <div className="row gap-3">
              ...
              <Button><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="mr-2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>Add Project</Button>
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="bg-foreground text-surface border-border relative overflow-hidden group hover:-translate-y-1 transition-default shadow-float-light">
              ...
              <CardContent className="pt-6 relative z-10">
                <div className="t-body-sm c-subtle mb-4">Total Projects</div>
                <div className="dot-display dot-display-xl mb-4">24</div>
            ...
            <Card className="bg-surface-card border-border hover:surface-shift hover:-translate-y-1 transition-default relative group">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            <Card className="col-span-12 lg:col-span-5 bg-surface-card border-border flex flex-col p-6">
            ...
            <Card className="col-span-12 lg:col-span-3 bg-surface-card border-border flex flex-col justify-between p-6">
              <div>
            ...
            <Card className="col-span-12 lg:col-span-4 bg-surface-card border-border p-6">
              <div className="row-between mb-6">
                <h3 className="t-h3">Projects</h3>
                <Button variant="secondary" size="sm"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="mr-1"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>New</Button>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 pb-12">
            <Card className="col-span-12 lg:col-span-5 bg-surface-card border-border p-6">
              <div className="row-between mb-6">
            ...
            <Card className="col-span-12 lg:col-span-4 bg-surface-card border-border flex flex-col justify-between p-6">
            ...
            <Card className="col-span-12 lg:col-span-3 bg-foreground text-surface border-border flex flex-col justify-between overflow-hidden relative transition-default p-6 border-none">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div className="mt-8 stack items-center w-full">
                  ...
                  <div className="row gap-4">
                    <Button variant="secondary" className="bg-surface-highest border-none text-foreground btn-icon radius-full w-12 h-12 opacity-80 hover:opacity-100 transition-fast" title="Pause">
